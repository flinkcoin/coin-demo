...
import static org.flinkcoin.evm.crypto.HashUtil.sha3;
import static org.flinkcoin.evm.vm.VMUtils.getSizeInWords;
...
public class VM {
    ...
    {{
        ...
        put(OpCode.EXTCODEHASH, BlockchainConfig::eip1052);
        put(OpCode.SHL, BlockchainConfig::eip145);
        put(OpCode.SHR, BlockchainConfig::eip145);
        put(OpCode.SAR, BlockchainConfig::eip145);
        put(OpCode.CREATE2, BlockchainConfig::eip1014);
    }};
    ...
    private void dumpLine(OpCode op, long gasBefore, long gasCost, long memWords, Program program) {
        if (config.dumpStyle().equals("standard+")) {
            ...
            String pcString = ByteUtil.toHexString(DataWord.of(program.getPC()).getNoLeadZeroesData());
