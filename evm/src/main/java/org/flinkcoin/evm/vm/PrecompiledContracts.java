...
import org.flinkcoin.evm.crypto.ECKey;
import org.flinkcoin.evm.crypto.HashUtil;
import org.ethereum.crypto.zksnark.*;
import org.flinkcoin.evm.util.BIUtil;
import org.flinkcoin.evm.crypto.zksnark.*;
...
public class PrecompiledContracts {
    ...
    public static class Sha256 extends PrecompiledContract {
        ...
        public Pair<Boolean, byte[]> execute(byte[] data) {
            ...
            if (data == null) return Pair.of(true, HashUtil.sha256(ByteUtil.EMPTY_BYTE_ARRAY));
    ...
    public static class ModExp extends PrecompiledContract {
        ...
        public long getGasForData(byte[] data) {
            ...
            if (data == null) data = ByteUtil.EMPTY_BYTE_ARRAY;
            ...
            return BIUtil.isLessThan(gas, BigInteger.valueOf(Long.MAX_VALUE)) ? gas.longValue() : Long.MAX_VALUE;
        }
