...
import org.flinkcoin.evm.core.Bloom;
import org.flinkcoin.evm.crypto.HashUtil;
import org.flinkcoin.evm.datasource.MemSizeEstimator;
import org.flinkcoin.evm.util.RLP;
import org.flinkcoin.evm.util.RLPElement;
import org.flinkcoin.evm.util.RLPItem;
import org.flinkcoin.evm.util.RLPList;
import org.flinkcoin.evm.util.*;
...
public class LogInfo {
    ...
    public static final MemSizeEstimator<LogInfo> MemEstimator = log ->
            MemSizeEstimator.ByteArrayEstimator.estimateSize(log.address) +
            MemSizeEstimator.ByteArrayEstimator.estimateSize(log.data) +
