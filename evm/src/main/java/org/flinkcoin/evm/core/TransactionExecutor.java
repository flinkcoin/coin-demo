 ...
 */
package org.flinkcoin.evm.core;
...
import org.flinkcoin.evm.vm.LogInfo;
import org.flinkcoin.evm.vm.PrecompiledContracts;
import org.flinkcoin.evm.vm.VM;
import static org.flinkcoin.evm.vm.VMUtils.saveProgramTraceFile;
import static org.flinkcoin.evm.vm.VMUtils.zipAndEncode;
import org.flinkcoin.evm.vm.hook.VMHook;
import org.flinkcoin.evm.vm.program.Program;
import org.flinkcoin.evm.vm.program.ProgramResult;
import org.flinkcoin.evm.vm.program.Transaction;
...
public class TransactionExecutor {
    ...
    /**
     * Do all the basic validation, if the executor will be ready to run the transaction at the end set readyToExecute = true
     */
    public void init() {
