...
public interface Repository extends org.ethereum.facade.Repository {
    ...
    /**
     * Dump the full state of the current repository into a file with JSON format It contains all the contracts/account, their attributes and
     *
     ...
     * @param txHash is the hash of the given transaction. If null, the block state post coinbase reward is dumped.
     */
    ...
    /**
     * Clones repository so changes made to this repository are not reflected in its clone.
     */
    Repository clone();
}
