...
import org.flinkcoin.evm.config.blockchain.ConstantinopleConfig;
import org.flinkcoin.evm.config.blockchain.DaoHFConfig;
...
public class VMMemoryOpTest extends VMBaseOpTest {
    ...
    private void testSWAPN_1(int n) {
        ...
        for (int i = n; i > -1; --i) {
            programCode += "PUSH1 0x" + ByteUtil.oneByteToHexString((byte) (0x10 + i)) + " ";
        }
